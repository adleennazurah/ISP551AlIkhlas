...
<br>	
	...
	<form action="AddAnimalController" method="post">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="animalqty" name="animalqty">
    </div>
  
  <div class="form-group">
    <label for="animalprice"> Animal Price:</label>
    <input type="text" class="form-control" id="animalprice" name="animalprice">
    </div>
