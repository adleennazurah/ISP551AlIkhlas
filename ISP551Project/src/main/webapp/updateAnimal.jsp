...
<br>
	...
	<form action="UpdateAnimalController" method="post">
  <div class="form-group">
    <label for="animalname">Animal Name:</label>
   <input type="text" name="animalname" class="form-control" value="<c:out value="${an.animalname}"/>"/>
  </div>
  <div class="form-group">
    <label for="animalqty">Animal Quantity:</label>
    <input type="number" name="animalqty" class="form-control" value="<c:out value="${an.animalqty}"/>"/>
    </div>
  
  <div class="form-group">
    <label for="animalprice"> Animal Price:</label>
  <input type="text" name="animalprice" class="form-control" value="<c:out value="${an.animalprice}"/>"/>
    </div>
