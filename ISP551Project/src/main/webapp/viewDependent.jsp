...
<br>
<a href="ListDependentController">List Customer</a><br><br>
<div class= "container col-md-5">
<div class="card">
<div class="card-body">
	<h1>Dependent Info</h1>
	<centre>
	Dependent Id: <c:out value="${d.dependentid}"/><br>
	Dependent Name: <c:out value="${d.dependentname}"/><br>
	Telephone Number: <c:out value="${d.telephoneno}"/><br>
	</centre>
	</div></div></div>
