...
<br><br>
	...
	<form action="UpdateDependentController" method="post">
	Dependent Name: <br>
	<input type="text" class="w3-input w3-border" name="dependentname" value="<c:out value="${d.dependentname}"/>"/><br>
	Telephone No: <br>
	<input type="number" class="w3-input w3-border" name="telephoneno" value="<c:out value="${d.telephoneno}"/>"/><br>
	
	<input type="hidden" name="dependentid" value="<c:out value="${d.dependentid}"/>"/><br><br>
	<input class="w3-button w3-black" type="submit" value="Update">
